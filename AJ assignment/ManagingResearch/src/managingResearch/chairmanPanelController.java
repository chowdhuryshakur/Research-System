 ...
 * @author User
 */
public class chairmanPanelController implements Initializable {
private final String DB_USERNAME = "shakur999";
   ...
   private final String DB_URL = "jdbc:mysql://"+DB_HOSTNAME+"/"+DB_DBNAME;
    ...
    @FXML
    private void handleStudentAssignmentButtonAction(ActionEvent event) throws IOException {
     AnchorPane pane =FXMLLoader.load(getClass().getResource("supervisorAssignment.fxml"));
                         teacherPanel.getChildren().setAll(pane);
    }

    @FXML
    private void nonApplyStudentButtonAction(ActionEvent event) throws IOException {
    AnchorPane pane =FXMLLoader.load(getClass().getResource("seeNonApplyStudent.fxml"));
                         teacherPanel.getChildren().setAll(pane);
    }

    @FXML
    private void handleNonERSupervisorButtonAction(ActionEvent event) throws IOException {
    AnchorPane pane =FXMLLoader.load(getClass().getResource("seeNonERTeacher.fxml"));
                         teacherPanel.getChildren().setAll(pane);
    }
